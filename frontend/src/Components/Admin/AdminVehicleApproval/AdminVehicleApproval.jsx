...
function AdminVehicleApproval() {
    ...
    if (loading) {
        return <div className="vehicle-approval-loading">Loading pending vehicles...</div>;
    }
    ...
    return (
        <div className="admin-vehicle-approval">
                    ...
                    {vehicles.map((vehicle) => (
                        ...
                        >
                            <div className="vehicle-header">
                                ...
                                <span className="registration">{vehicle.registrationNumber}</span>
                            </div>
            ...
            {/* Rejection Modal */}
            {selectedVehicle && vehicles.find(v => v._id === selectedVehicle._id) && (
                <div className="rejection-modal-overlay" onClick={() => setSelectedVehicle(null)}>
                    <div className="rejection-modal" onClick={e => e.stopPropagation()}>
                        <h3>Reject Vehicle</h3>
                        <p>Vehicle: {selectedVehicle.vehicleName} ({selectedVehicle.registrationNumber})</p>
